...
public static class MigrationBuilderExtensions
{
    public static void AllMigrate(this MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData("Products",
                                    new string[]
                                    {
                                        "Id","ProductName","CategoryId","Color","Dimension","Stock","IsActive","IsDeleted"
                                    },
                                    new object[,]
                                    {
                                        {"49688046-98BC-4557-A2D8-FE4441FE7D1B", "Marble","0E391BC2-F4D1-4D3E-A3BC-B0B52874EA0E",1,1,100,true,false},
                                    });
        ...
        migrationBuilder.InsertData("Orders",
                                    new string[]
                                    {
                                        "Id","CustomerId", "OrderDate","IsActive","IsDeleted","Adress"
                                    },
                                    new object[,]
                                    {
                                        {"6DBF4B6F-7C84-457D-9135-FC49E0FEFC0C", "105280BE-6DCC-4ACC-BBA9-B6E7C8CFED19",DateTime.Now,true,false,"İzmir"},
                                    });
